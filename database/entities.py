...
from sqlalchemy import MetaData, Integer, String, BigInteger, DateTime, Boolean, ForeignKey
...
class Ad(Base):
    ...
    category_id: Mapped[int] = mapped_column(ForeignKey('ad_categories.id'), nullable=True)
