...
start_keyboard = InlineKeyboardMarkup([
    [InlineKeyboardButton(text='Создать объявление', callback_data=create_ad_callback)],
...
conversation_skip_image_keyboard = InlineKeyboardMarkup([
    [InlineKeyboardButton(text='Пропустить', callback_data=conversation_skip_image_callback)],
    [InlineKeyboardButton(text='Отменить', callback_data=return_to_start_callback)]
])
...
category_ad_keyboard = InlineKeyboardMarkup([
    ...
    [
        ...
        InlineKeyboardButton(text='Услуги', callback_data=services_category_callback)
    ],
    [
        InlineKeyboardButton(text='Отменить', callback_data=return_to_start_callback)
    ]
...
def create_contact_keyboard(seller_contact):
    return InlineKeyboardMarkup([[InlineKeyboardButton(text='Написать продавцу', url=seller_contact)]])


def ad_keyboard(ad_id):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton(text='Снять с публикации', callback_data=f'delete_ad_{ad_id}')],
        [InlineKeyboardButton(text='Назад', callback_data=return_to_start_callback)]
    ])
...
def validate_keyboard(ad_id):
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton(text=publish_ad_text, callback_data=f'approve_ad_{ad_id}'),
            InlineKeyboardButton(text='Отклонить', callback_data=f'disapprove_ad_{ad_id}')
        ],
        [InlineKeyboardButton(text='Назад', callback_data=return_to_start_callback)]
    ])
